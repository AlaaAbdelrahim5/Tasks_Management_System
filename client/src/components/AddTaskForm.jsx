...
const AddTaskForm = ({ onClose, onSubmit }) => {
  ...
  const validateDueDate = (dueDate, startDate) => {
    ...
    const endDateTime = selectedProject?.endDate
      ? new Date(selectedProject.endDate).getTime()
      : null;

    if (dueDateTime < startDateTime) {
      setDateError(
        `Due date cannot be before project start date (${startDate})`
      );
    } else if (endDateTime && dueDateTime > endDateTime) {
      setDateError(
        `Due date cannot be after project end date (${selectedProject.endDate})`
      );
    } else {
      setDateError("");
    }
  ...
  const handleSubmit = (e) => {
    ...
    const newFieldErrors = {
      ...
      student: !user?.isStudent
        ? validateField("student", formData.assignedStudents[0])
        : "",
  ...
  const renderValidationMessage = (errorMessage) => {
    ...
    return (
      <div
        className={`absolute ${
          darkMode ? "bg-orange-900/90" : "bg-orange-100"
        } ${
          darkMode ? "text-orange-100" : "text-orange-800"
        } px-3 py-1 rounded-md shadow-lg z-10 flex items-center right-0 -top-8`}
      >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-transparent backdrop-blur-sm">
      <div
        className={`w-full max-w-md p-1 rounded-xl ${
          darkMode
          ...
          <div className="space-y-5">
            <div className="relative">
              ...
              <select
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border-2 ${
                  fieldErrors.project
                    ? "border-orange-500"
                    : "border-" + (darkMode ? "gray-600" : "gray-200")
                } ${fieldBg} focus:outline-none focus:ring-2 focus:ring-${
                  fieldErrors.project ? "orange" : accentColor
              ...
              <label
                className={`text-xs font-medium ${
                  fieldErrors.project ? "text-orange-500" : labelColor
                } absolute -top-2 left-2 px-1 ${formBg}`}
              >
                Project
                {fieldErrors.project && (
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border-2 ${
                  ...
                  fieldErrors.name ? "orange" : accentColor
                }-500 focus:border-transparent transition-all`}
              />
              <label
                className={`text-xs font-medium ${
                  fieldErrors.name ? "text-orange-500" : labelColor
                } absolute -top-2 left-2 px-1 ${formBg}`}
              >
                Task Name
                {fieldErrors.name && (
            ...
            <div className="relative">
              ...
              <textarea
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border-2 ${
                  ...
                  fieldErrors.description ? "orange" : accentColor
                }-500 focus:border-transparent transition-all`}
              />
              <label
                className={`text-xs font-medium ${
                  fieldErrors.description ? "text-orange-500" : labelColor
                } absolute -top-2 left-2 px-1 ${formBg}`}
              >
                Description
                {fieldErrors.description && (
            ...
            <div className="relative">
              ...
              {user?.isStudent ? (
                <input
                  ...
                  value={user.username}
                  readOnly
                  className={`w-full pl-10 pr-4 py-3 rounded-lg border-2 border-${
                    darkMode ? "gray-600" : "gray-200"
                  } ${fieldBg} focus:outline-none focus:ring-2 focus:ring-${accentColor}-500 focus:border-transparent transition-all opacity-75`}
                />
              ) : (
                <select
                  name="student"
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-lg border-2 ${
                    ...
                    fieldErrors.student ? "orange" : accentColor
                  }-500 focus:border-transparent transition-all`}
                >
              ...
              <label
                className={`text-xs font-medium ${
                  fieldErrors.student ? "text-orange-500" : labelColor
                } absolute -top-2 left-2 px-1 ${formBg}`}
              >
                Assigned Student
                {fieldErrors.student && (
            ...
            <div className="relative">
              ...
              <select
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border-2 border-${
                  darkMode ? "gray-600" : "gray-200"
                } ${fieldBg} focus:outline-none focus:ring-2 focus:ring-${accentColor}-500 focus:border-transparent transition-all`}
              >
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border-2 ${
                  ...
                  fieldErrors.dueDate || dateError ? "orange" : accentColor
                }-500 focus:border-transparent transition-all`}
              />
              <label
                className={`text-xs font-medium ${
