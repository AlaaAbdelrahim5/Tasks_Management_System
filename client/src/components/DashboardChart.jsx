...
const DashboardChart = ({
      ...
      if (chartRef.current) {
        ...
        if (data) {
          ...
          if (!isStudent) {
            ...
            backgroundColor.splice(
              1,
              0,
              darkMode
                ? "rgba(255, 138, 161, 0.85)"
                : "rgba(255, 99, 132, 0.85)"
            );
            borderColor.splice(
              1,
              0,
              darkMode ? "rgba(255, 138, 161, 1)" : "rgba(255, 99, 132, 1)"
            );
          }
        }
            ...
            datasets: [
              {
                ...
                borderRadius: 12,
                maxBarThickness: 60,
                hoverBackgroundColor: backgroundColor.map((c) =>
                  c.replace("0.85", "1")
                ),
  ...
  return (
    <div
      ...
      style={{
        height: data ? "360px" : "480px",
        minWidth: data ? "300px" : "340px",
        boxShadow: darkMode
