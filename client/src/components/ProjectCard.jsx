...
const ProjectCard = ({ project, darkMode }) => {
  ...
  const progress =
    project.progress || getProgress(project.startDate, project.endDate);
  ...
  const getStatusColor = (status) => {
    ...
    return (
      statusColors[status] ||
      (darkMode ? "from-gray-600 to-gray-400" : "from-gray-600 to-gray-400")
    );
  };
  return (
    <div
    ...
    >
      ...
      <div
        className={`absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r ${getStatusColor(
          project.status
        )}`}
      ></div>
        ...
        <div className="flex justify-between items-start mb-3">
          <div>
            ...
            <div className="mt-1 flex items-center">
              <div
                className={`inline-block px-2.5 py-0.5 rounded-md text-xs font-medium mr-2 ${
                  darkMode
