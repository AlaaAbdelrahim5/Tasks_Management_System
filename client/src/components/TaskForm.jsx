      ...
      <div className="w-full max-w-lg p-1 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 shadow-xl">
        ...
        >
          <h2 className="text-2xl font-bold mb-6 text-center">
            ...
            <div
              className={`h-1 w-16 bg-${accentColor} mx-auto mt-2 rounded-full`}
            ></div>
          </h2>
          <div className="space-y-4">
            <div className="relative">
              <div
                className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-${accentColor}`}
              >
                <FaProjectDiagram />
              </div>{" "}
              <select
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border-2 ${
                  dateError ? "border-red-500" : fieldBg
                } focus:outline-none focus:ring-2 focus:ring-${
                  dateError ? "red-500" : accentColor
                } focus:border-transparent transition-all`}
                required
              />
              <label
                className={`text-xs font-medium ${
                  dateError ? "text-red-500" : labelColor
